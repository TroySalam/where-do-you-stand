...
const PRESIDENT_DATA = {
  ...
  fdr: {
    ...
    questions: [
      ...
      { text: "FDR hired millions of unemployed Americans through the Works Progress Administration (WPA) to build roads, bridges, and public buildings during the Great Depression — which meant the government became the employer of last resort.", axis: "economy", pole: "left" },
      { text: "FDR created the Civilian Conservation Corps (CCC), paying young men to plant trees, build trails, and work on national parks and forests during the Depression.", axis: "economy", pole: "left" },
      { text: "FDR created the FDIC in 1933, a system where the government guarantees bank deposits — so if your bank collapses, you don't lose your savings.", axis: "economy", pole: "left" },
      { text: "FDR created the Securities and Exchange Commission (SEC), a federal agency to police Wall Street and prevent the reckless gambling with investors' money that caused the 1929 stock market crash.", axis: "economy", pole: "left" },
      ...
      { text: "FDR signed the National Labor Relations Act in 1935, guaranteeing workers the right to form unions and bargain together for better wages and conditions.", axis: "economy", pole: "left" },
      { text: "FDR imposed agricultural price controls during the New Deal, paying farmers to produce less so that crop prices would rise — helping farmers stay afloat but raising food costs.", axis: "economy", pole: "left" },

      // SOCIETY (4)
      { text: "FDR issued Executive Order 9066 in 1942, forcing approximately 120,000 Japanese Americans — most of them US citizens — into government prison camps during World War II.", axis: "society", pole: "right" },
      ...
      { text: "FDR created the Federal Housing Administration to make homeownership more affordable, but its lending guidelines effectively blocked Black families from getting loans in many neighborhoods — a practice called redlining.", axis: "society", pole: "right" },

      // GOVERNANCE (7)
      { text: "FDR tried to pack the Supreme Court in 1937 by proposing to add up to six new justices after the Court struck down several of his programs — widely seen as an attempt to get friendlier judges.", axis: "governance", pole: "right" },
      ...
      { text: "FDR used executive orders extensively to implement his New Deal programs, bypassing a sometimes reluctant Congress.", axis: "governance", pole: "right" },
      { text: "FDR used 'fireside chats' — radio addresses — to speak directly to the American people, bypassing traditional media gatekeepers.", axis: "governance", pole: "right" },
      { text: "FDR signed an order granting the military authority to forcibly remove civilians from their homes and relocate them without any trial or legal process.", axis: "governance", pole: "right" },
      { text: "FDR centralized enormous economic authority in the federal government through the National Recovery Administration, setting industry-wide rules for wages, prices, and competition.", axis: "governance", pole: "right" },
      { text: "FDR created the Tennessee Valley Authority (TVA), a government-owned power company that brought electricity and economic development to a poverty-stricken region of the South.", axis: "economy", pole: "left" },

      // UNIVERSALITY (5)
      { text: "FDR signed the Lend-Lease Act in 1941, sending billions of dollars worth of weapons and supplies to Britain and other Allied nations before the US formally entered World War II.", axis: "universality", pole: "left" },
      ...
      { text: "FDR met with Churchill and Stalin at the Yalta Conference in 1945, negotiating how Europe would be divided after the war and how the United Nations would work.", axis: "universality", pole: "left" },
      ...
      { text: "FDR established the Soil Conservation Service to combat the Dust Bowl, funding programs that taught farmers how to stop their topsoil from blowing away across the Great Plains.", axis: "environment", pole: "left" },
  ...
  truman: {
    ...
    questions: [
      ...
      { text: "Truman signed the National Security Act of 1947, creating the CIA (the country's main intelligence spy agency), the National Security Council, and the Department of Defense.", axis: "governance", pole: "right" },
      ...
      { text: "Truman helped create NATO, a military alliance where the US and European countries agreed that an attack on one member would be treated as an attack on all of them.", axis: "universality", pole: "left" },
      ...
      // EXPANSION (5)
      { text: "Truman approved continued development of nuclear weapons after WWII, setting off an arms race with the Soviet Union that would define the Cold War.", axis: "expansion", sub: "technology", pole: "left" },
  ...
  eisenhower: {
    ...
    questions: [
      ...
      { text: "Eisenhower signed the Civil Rights Act of 1957, the first federal civil rights legislation since the post-Civil War era, creating a commission to investigate voting rights violations.", axis: "society", pole: "left" },
      ...
      { text: "Eisenhower authorized the CIA to overthrow the democratically elected government of Iran in 1953 and install a pro-US king (the Shah), primarily to protect Western oil interests.", axis: "governance", pole: "right" },
      { text: "Eisenhower authorized the CIA to overthrow the government of Guatemala in 1954, replacing a democratically elected president with a military dictator to prevent the spread of communism in Central America.", axis: "governance", pole: "right" },
      { text: "Eisenhower used the CIA for covert operations worldwide, establishing a precedent for secret government interference in foreign countries.", axis: "governance", pole: "right" },
      ...
      { text: "Eisenhower authorized covert CIA operations in multiple countries to install pro-American governments, prioritizing US strategic interests over democratic principles.", axis: "universality", pole: "right" },
      ...
      // EXPANSION (6)
      { text: "Eisenhower created NASA in 1958 and launched the US space program in response to the Soviet Sputnik satellite beating America into orbit.", axis: "expansion", sub: "space", pole: "left" },
      { text: "Eisenhower signed the law that established NASA, making sure space exploration was run by a civilian agency rather than the military.", axis: "expansion", sub: "space", pole: "left" },
      ...
      { text: "Eisenhower launched DARPA (originally ARPA), a Pentagon agency created to develop advanced military technology — which later gave rise to the internet.", axis: "expansion", sub: "technology", pole: "left" },
  ...
  jfk: {
    ...
    questions: [
      ...
      // SOCIETY (5)
      { text: "Kennedy proposed comprehensive civil rights legislation in 1963 that would ban racial discrimination in public places and employment (passed as the Civil Rights Act of 1964 after his death).", axis: "society", pole: "left" },
      ...
      // GOVERNANCE (6)
      { text: "Kennedy approved the Bay of Pigs invasion in 1961, a CIA-backed attempt to use Cuban exiles to overthrow Fidel Castro's government — which failed badly and embarrassed the US.", axis: "governance", pole: "right" },
      ...
      { text: "Kennedy authorized the FBI to secretly wiretap Martin Luther King Jr. as part of surveillance operations against civil rights leaders.", axis: "governance", pole: "right" },
      ...
      { text: "Kennedy increased NASA's budget by nearly 500% to fund the Apollo moon program, making space exploration a top national priority.", axis: "expansion", sub: "space", pole: "left" },
  ...
  lbj: {
    ...
    questions: [
      ...
      { text: "LBJ signed Medicaid into law in 1965, providing government-funded healthcare for low-income Americans who couldn't afford private insurance.", axis: "economy", pole: "left" },
      { text: "LBJ launched the War on Poverty in 1964, creating programs like Head Start (early childhood education), Job Corps (job training for poor youth), and community action groups to fight poverty.", axis: "economy", pole: "left" },
      { text: "LBJ dramatically expanded the federal food stamp program, allowing low-income Americans to use government vouchers to buy groceries.", axis: "economy", pole: "left" },
      { text: "LBJ signed the Elementary and Secondary Education Act in 1965, directing billions in federal funds to public schools for the first time — especially schools in poor areas.", axis: "economy", pole: "left" },
      { text: "LBJ created the Department of Housing and Urban Development (HUD), a cabinet-level agency to address housing shortages and urban poverty.", axis: "economy", pole: "left" },
      { text: "LBJ created the Department of Transportation to coordinate federal policy on roads, railways, air travel, and shipping.", axis: "economy", pole: "left" },
      ...
      // SOCIETY (8)
      { text: "LBJ signed the Civil Rights Act of 1964, making it illegal to discriminate based on race, color, religion, sex, or national origin in employment and public places like hotels and restaurants.", axis: "society", pole: "left" },
      { text: "LBJ signed the Voting Rights Act of 1965, banning literacy tests and other tricks used to stop Black Americans from voting, and allowing federal oversight of elections in discriminatory states.", axis: "society", pole: "left" },
      { text: "LBJ signed the Fair Housing Act of 1968, making it illegal to refuse to sell or rent a home to someone because of their race, religion, or national origin.", axis: "society", pole: "left" },
      { text: "LBJ signed the Immigration and Nationality Act of 1965, replacing a system that heavily favored immigrants from Western Europe with one that treated people from all countries more equally.", axis: "society", pole: "left" },
      { text: "LBJ created Head Start, providing early childhood education, meals, and health screenings for young children from low-income families.", axis: "society", pole: "left" },
      { text: "LBJ appointed Thurgood Marshall as the first Black justice on the Supreme Court in 1967.", axis: "society", pole: "left" },
      { text: "LBJ signed the Higher Education Act of 1965, creating federal scholarships, student loans, and work-study programs so more Americans could afford college.", axis: "society", pole: "left" },
      { text: "LBJ established the National Endowment for the Arts and the National Endowment for the Humanities, creating federal agencies to fund museums, theaters, research, and cultural programs.", axis: "society", pole: "left" },

      // GOVERNANCE (5)
      { text: "LBJ escalated the Vietnam War based on the Gulf of Tonkin Resolution — a congressional authorization granted after an alleged attack on US ships that was later found to have been exaggerated or fabricated.", axis: "governance", pole: "right" },
      ...
      { text: "LBJ used the FBI to spy on civil rights leaders and anti-war activists, expanding domestic intelligence operations against American citizens.", axis: "governance", pole: "right" },
      ...
      { text: "LBJ used intense personal lobbying tactics to push landmark legislation through Congress, applying direct pressure to individual members of Congress.", axis: "governance", pole: "right" },
      ...
      { text: "LBJ signed the Immigration and Nationality Act of 1965, replacing the old quota system — which heavily favored Europeans — with one based on family reunification and job skills.", axis: "universality", pole: "left" },
      ...
      // ENVIRONMENT (3)
      { text: "LBJ signed the Wilderness Act of 1964, permanently protecting 9.1 million acres of federal land from logging, mining, and development.", axis: "environment", pole: "left" },
      { text: "LBJ signed the Highway Beautification Act of 1965, limiting billboards along federal highways and promoting roadside landscaping.", axis: "environment", pole: "left" },
      { text: "LBJ signed the Clean Air Act of 1963, establishing the first federal standards to limit air pollution from factories and vehicles.", axis: "environment", pole: "left" },

      // EXPANSION (2)
      { text: "LBJ continued Kennedy's Apollo moon program and kept NASA's budget high, overseeing the missions that led to the 1969 Moon landing.", axis: "expansion", sub: "space", pole: "left" },
      { text: "LBJ signed the Public Broadcasting Act of 1967, creating PBS (public television) and NPR (public radio) to provide educational media free from commercial pressure.", axis: "expansion", sub: "technology", pole: "left" }
    ]
  },
  ...
  nixon: {
    ...
    questions: [
      ...
      { text: "Nixon signed the law creating OSHA (Occupational Safety and Health Administration) in 1970, which set federal rules for workplace safety — like requiring protective equipment and limiting dangerous chemical exposure.", axis: "economy", pole: "left" },
      ...
      { text: "Nixon signed the SALT I agreement with the Soviet Union in 1972, the first treaty to actually put limits on how many nuclear missiles each side could have.", axis: "universality", pole: "left" },
      ...
      // ENVIRONMENT (4)
      { text: "Nixon created the Environmental Protection Agency (EPA) in 1970, a dedicated federal agency with the power to set and enforce environmental regulations.", axis: "environment", pole: "left" },
      ...
      // EXPANSION (2)
      { text: "Nixon approved the Space Shuttle program, shifting NASA away from the Apollo moon missions toward a reusable spacecraft designed for repeated launches.", axis: "expansion", sub: "space", pole: "left" },
  ...
  ford: {
    ...
    questions: [
      ...
      { text: "Ford deregulated the railroad industry, reducing government control over rail pricing and routes to allow more market competition.", axis: "economy", pole: "right" },
      ...
      { text: "Ford supported the Church Committee investigations into CIA and FBI abuses of power, which revealed that both agencies had been illegally spying on American citizens for decades.", axis: "governance", pole: "left" },
      ...
      // ENVIRONMENT (2)
      { text: "Ford signed the Toxic Substances Control Act in 1976, giving the EPA authority to regulate hazardous chemicals and require safety testing before they enter the market.", axis: "environment", pole: "left" },
  ...
  carter: {
    ...
    questions: [
      // ECONOMY (5)
      { text: "Carter deregulated the airline industry in 1978, ending government control of which routes airlines could fly and how much they could charge — which led to cheaper tickets but also more bankruptcies.", axis: "economy", pole: "right" },
      { text: "Carter deregulated the trucking and railroad industries, removing federal price controls and letting companies compete more freely on price and service.", axis: "economy", pole: "right" },
      ...
      { text: "Carter established FEMA (Federal Emergency Management Agency) in 1979, creating a dedicated federal agency to coordinate disaster response when hurricanes, floods, and other emergencies hit.", axis: "governance", pole: "left" },
      ...
      { text: "Carter imposed a grain embargo on the Soviet Union after its invasion of Afghanistan in 1979, stopping US wheat sales as a form of economic pressure.", axis: "universality", pole: "right" },
      ...
      { text: "Carter negotiated the SALT II arms limitation treaty with the Soviet Union to cap the number of nuclear missiles each side could build, though the Senate never ratified it.", axis: "universality", pole: "left" },
  ...
  reagan: {
    ...
    questions: [
      ...
      { text: "Reagan pursued widespread deregulation of industries including savings and loans, telecommunications, and transportation, removing government rules that had previously limited what companies could do.", axis: "economy", pole: "right" },
      ...
      // GOVERNANCE (5)
      { text: "The Iran-Contra affair revealed that Reagan's administration had secretly sold weapons to Iran (in violation of an arms embargo) and secretly used the proceeds to fund anti-communist rebels in Nicaragua — in defiance of a law Congress had passed banning such funding.", axis: "governance", pole: "right" },
      ...
      { text: "Reagan supported the Contras — anti-communist guerrillas in Nicaragua — through secret CIA operations, funding them even after Congress passed a law banning such support.", axis: "governance", pole: "right" },
      ...
      { text: "Reagan signed the INF Treaty in 1987, a deal with the Soviet Union that eliminated an entire class of nuclear missiles — the first agreement to actually destroy weapons rather than just cap their numbers.", axis: "universality", pole: "left" },
      ...
      { text: "Reagan imposed economic sanctions on South Africa's apartheid government, though only after Congress overrode his veto of the sanctions bill.", axis: "universality", pole: "left" },
      ...
      { text: "Reagan cut the EPA's budget by nearly 30% and appointed administrators who were skeptical of environmental regulation, weakening enforcement of pollution rules.", axis: "environment", pole: "right" },
      ...
      // EXPANSION (4)
      { text: "Reagan launched the Strategic Defense Initiative (SDI, nicknamed 'Star Wars') — a proposed system of space-based lasers and missiles that could shoot down incoming nuclear warheads before they hit the US.", axis: "expansion", sub: "technology", pole: "left" },
  ...
  ghwbush: {
    ...
    questions: [
      ...
      { text: "Bush signed the savings and loan bailout, spending over $100 billion in taxpayer funds to rescue hundreds of banks that had collapsed after being deregulated in the 1980s.", axis: "economy", pole: "left" },
      { text: "Bush negotiated the framework for NAFTA (North American Free Trade Agreement) — a deal to remove taxes on goods traded between the US, Canada, and Mexico — which Clinton later signed into law.", axis: "economy", pole: "right" },
      ...
      // SOCIETY (5)
      { text: "Bush signed the Americans with Disabilities Act (ADA) in 1990, prohibiting discrimination against people with disabilities in workplaces, public transportation, restaurants, hotels, and other areas of life.", axis: "society", pole: "left" },
      ...
      // GOVERNANCE (5)
      { text: "Bush ordered the invasion of Panama in 1989 to remove dictator Manuel Noriega, who had been a CIA informant before being indicted for drug trafficking.", axis: "governance", pole: "right" },
      ...
      { text: "Bush assembled a coalition and obtained UN authorization before launching the Gulf War to liberate Kuwait, following established international legal processes rather than acting unilaterally.", axis: "governance", pole: "left" },
      ...
      { text: "Bush negotiated the START I treaty with the Soviet Union, the first agreement to actually reduce the number of long-range nuclear warheads each side had — cutting them by about 35%.", axis: "universality", pole: "left" },
      { text: "Bush supported German reunification in 1990, encouraging the peaceful merger of communist East Germany into democratic West Germany, which remained part of NATO.", axis: "universality", pole: "left" },
      ...
      { text: "Bush imposed limited sanctions on China after the Tiananmen Square massacre — where the Chinese military killed hundreds of pro-democracy protesters — but maintained trade relations.", axis: "universality", pole: "left" },
      { text: "Bush negotiated the NAFTA framework, promoting the removal of trade tariffs and open economic exchange across North America.", axis: "universality", pole: "left" },
  ...
  clinton: {
    ...
    questions: [
      // ECONOMY (7)
      { text: "Clinton signed a trade deal (NAFTA) that removed taxes on goods traded between the US, Canada, and Mexico — making imports cheaper but causing some American factory jobs to move to lower-wage countries.", axis: "economy", pole: "right" },
      ...
      // SOCIETY (6)
      { text: "Clinton signed the Defense of Marriage Act (DOMA) in 1996, defining marriage under federal law as only between one man and one woman — denying same-sex couples access to federal marriage benefits.", axis: "society", pole: "right" },
      ...
      { text: "Clinton created the Children's Health Insurance Program (CHIP) in 1997, providing government-funded health coverage to children from families that earned too much for Medicaid but couldn't afford private insurance.", axis: "society", pole: "left" },
      ...
      { text: "Clinton expanded NATO to include former Warsaw Pact countries Poland, Hungary, and the Czech Republic — former Soviet allies that now joined the Western military alliance.", axis: "universality", pole: "left" },
      ...
      { text: "Clinton signed the Kyoto Protocol in 1997 — an international agreement committing industrialized countries to cut greenhouse gas emissions — though the Senate never ratified it and the US never met its targets.", axis: "environment", pole: "left" },
  ...
  gwbush: {
    ...
    questions: [
      ...
      { text: "Bush signed the TARP (Troubled Asset Relief Program) bank bailout in 2008, authorizing $700 billion in taxpayer funds to rescue large banks that were on the verge of collapse during the financial crisis.", axis: "economy", pole: "left" },
      ...
      { text: "Bush pushed for deregulation of the housing market, encouraging expanded homeownership — a policy that contributed to the subprime mortgage bubble that burst in 2008.", axis: "economy", pole: "right" },
      ...
      { text: "Bush created PEPFAR (the President's Emergency Plan for AIDS Relief) in 2003, investing over $15 billion to fight HIV/AIDS in Africa — the largest program ever dedicated to fighting a single disease globally, saving millions of lives.", axis: "society", pole: "left" },
      ...
      // GOVERNANCE (8)
      { text: "Bush signed the USA PATRIOT Act after 9/11, dramatically expanding the government's ability to monitor phone calls, emails, and financial records — often without obtaining individual warrants.", axis: "governance", pole: "right" },
      ...
      { text: "Bush authorized the NSA (the government's electronic spy agency) to secretly monitor Americans' phone calls and internet communications without getting court approval first.", axis: "governance", pole: "right" },
      { text: "Bush authorized 'enhanced interrogation techniques' including waterboarding — a simulated drowning technique — on suspected terrorists held at Guantanamo Bay and secret CIA prisons around the world.", axis: "governance", pole: "right" },
      ...
      { text: "Bush used signing statements over 150 times to indicate he would not follow parts of laws he signed, effectively claiming the power to pick and choose which parts of legislation he'd obey.", axis: "governance", pole: "right" },
      ...
      { text: "Bush built a 'coalition of the willing' for the Iraq invasion — a group of allies willing to join without UN approval — bypassing the Security Council when it refused to authorize the war.", axis: "universality", pole: "right" },
  ...
  obama: {
    ...
    questions: [
      // ECONOMY (5)
      { text: "Obama signed the Affordable Care Act (ACA, often called Obamacare) in 2010, expanding government-subsidized health insurance to over 20 million previously uninsured Americans.", axis: "economy", pole: "left" },
      ...
      { text: "Obama created DACA (Deferred Action for Childhood Arrivals) in 2012 by executive order, protecting undocumented immigrants who were brought to the US as young children from being deported — because Congress refused to pass legislation.", axis: "society", pole: "left" },
      ...
      // GOVERNANCE (6)
      { text: "Obama used executive action to create DACA after Congress refused to pass comprehensive immigration reform, bypassing the legislative process — which critics argued exceeded presidential authority.", axis: "governance", pole: "right" },
      ...
      // UNIVERSALITY (6)
      { text: "Obama negotiated the Iran nuclear deal (JCPOA) in 2015, working with six other world powers to limit Iran's nuclear program in exchange for lifting economic sanctions — stopping Iran from building a nuclear bomb in exchange for trade.", axis: "universality", pole: "left" },
      ...
      { text: "Obama expanded NATO cooperation and imposed economic sanctions on Russia after it illegally seized Crimea from Ukraine in 2014.", axis: "universality", pole: "left" },
      ...
      // EXPANSION (3)
      { text: "Obama shifted NASA's focus toward partnering with private space companies like SpaceX rather than the government building and flying its own rockets.", axis: "expansion", sub: "space", pole: "left" },
  ...
  trump: {
    ...
    questions: [
      ...
      { text: "Trump renegotiated NAFTA into a new deal called the USMCA, updating trade rules for North America to require more car parts to be made in the US or Canada to qualify for zero tariffs.", axis: "economy", pole: "right" },
      { text: "Trump signed the CARES Act in 2020, authorizing $2.2 trillion in COVID-19 relief including $1,200 stimulus checks, boosted unemployment benefits, and forgivable loans for small businesses.", axis: "economy", pole: "left" },
      ...
      { text: "Trump signed the First Step Act in 2018, a bipartisan criminal justice reform bill that reduced some mandatory minimum sentences and made it easier for non-violent prisoners to earn early release.", axis: "society", pole: "left" },
      ...
      { text: "Trump withdrew from the Iran nuclear deal in 2018, reimposing heavy economic sanctions on Iran and walking away from the agreement that six other countries were still honoring.", axis: "universality", pole: "right" },
      ...
      { text: "Trump withdrew from the Trans-Pacific Partnership — a trade deal with 11 Pacific countries — on his first day in office, rejecting multilateral trade agreements in favor of one-on-one deals.", axis: "universality", pole: "right" },
  ...
  biden: {
    ...
    questions: [
      ...
      { text: "Biden signed the CHIPS and Science Act, investing $52 billion in subsidies to build semiconductor (computer chip) factories in the US, aiming to reduce dependence on chips made in Asia.", axis: "economy", pole: "left" },
      ...
      { text: "Biden signed the Bipartisan Safer Communities Act in 2022, the first major federal gun safety legislation in nearly 30 years, including expanded background checks and funding for mental health programs.", axis: "society", pole: "left" },
      ...
      { text: "Biden signed the PACT Act in 2022, expanding healthcare and disability benefits for veterans who were exposed to toxic smoke from open-air burn pits used to dispose of waste during military service.", axis: "society", pole: "left" },
      ...
      { text: "Biden organized international sanctions against Russia after its invasion of Ukraine, coordinating with European allies to cut Russia off from global financial markets.", axis: "universality", pole: "left" },
      ...
      // EXPANSION (2)
      { text: "Biden signed the CHIPS and Science Act, investing billions in semiconductor research and advanced technology manufacturing to keep the US competitive in the global tech race.", axis: "expansion", sub: "technology", pole: "left" },
...
const PRESIDENT_QUESTIONS = [
  ...
  { text: "Clinton signed a trade deal (NAFTA) that removed taxes on goods traded between the US, Canada, and Mexico — making imports cheaper but causing some American factory jobs to move overseas.", axis: "economy", pole: "right", president: "Clinton" },
  { text: "FDR hired millions of unemployed Americans through the Works Progress Administration to build roads, bridges, and public buildings during the Depression.", axis: "economy", pole: "left", president: "FDR" },
  ...
  { text: "FDR issued an executive order during WWII forcing approximately 120,000 Japanese Americans — most of them US citizens — into government prison camps.", axis: "governance", pole: "right", president: "FDR" },
  ...
  { text: "Obama used executive action to create DACA in 2012, protecting undocumented immigrants brought to the US as children from deportation — after Congress refused to pass legislation.", axis: "governance", pole: "right", president: "Obama" },
  ...
  { text: "Obama negotiated the Iran nuclear deal in 2015, working with six other world powers to limit Iran's nuclear program in exchange for lifting economic sanctions.", axis: "universality", pole: "left", president: "Obama" },
  ...
  // ── ENVIRONMENT (9) ──────────────────────────────────
  { text: "Nixon created the Environmental Protection Agency (EPA) in 1970, a dedicated federal agency with the power to set and enforce environmental regulations.", axis: "environment", pole: "left", president: "Nixon" },
  ...
  { text: "Eisenhower created NASA in 1958 and launched the US space program in response to the Soviet Sputnik satellite beating America into orbit.", axis: "expansion", sub: "space", pole: "left", president: "Eisenhower" },
  { text: "Obama shifted NASA's focus toward partnering with private space companies like SpaceX rather than the government building and flying its own rockets.", axis: "expansion", sub: "space", pole: "left", president: "Obama" },
  { text: "Truman approved continued development of nuclear weapons after WWII, leading to the hydrogen bomb and the nuclear arms race with the Soviet Union.", axis: "expansion", sub: "technology", pole: "left", president: "Truman" },
  { text: "Reagan launched the Strategic Defense Initiative ('Star Wars') — a proposed system of space-based lasers and missiles designed to shoot down incoming nuclear warheads.", axis: "expansion", sub: "technology", pole: "left", president: "Reagan" },
